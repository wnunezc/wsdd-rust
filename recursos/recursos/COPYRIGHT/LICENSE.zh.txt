...
版本 1.0.0-rc.3
版权 © 2026 Walter Núñez / Icaros Net S.A.
巴拿马。保留所有权利。

1. 许可

本软件以受控开源形式分发。源代码可以公开查阅，但其使用受本文档所定义限制的约束。
...
本软件的启动器可以从官方 GitHub 仓库自动下载更新。此行为属于软件正常功能的一部分，不构成重新分发。

5. 保证

本软件按“原样”提供，不附带任何形式的明示或默示保证。
