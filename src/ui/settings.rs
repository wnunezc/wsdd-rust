    ...
    egui::Window::new(&title)
        ...
        .show(ctx, |ui| {
            ...
            egui::ScrollArea::vertical().show(ui, |ui| {
                            ...
                            .show(ui, |ui| {
                                ...
                                ui.add(
                                    egui::TextEdit::singleline(&mut draft.projects_path)
                                        .desired_width(300.0)
                                        .hint_text(path_to_string(
                                            path_config().default_projects_root(),
                                        )),
                                );
                                ui.end_row();
                                ...
                                ui.add(
                                    egui::TextEdit::singleline(docker_val)
                                        .desired_width(300.0)
                                        .hint_text(format!(
                                            "{DEFAULT_DOCKER_DESKTOP_EXE} (opcional)"
                                        )),
                                );
                                ui.end_row();
                        ...
                        .show(ui, |ui| {
                            ...
                            for php_version in PhpVersion::all() {
                                let current = draft
                                    ...
                                    .cloned()
                                    .unwrap_or_else(|| {
                                        crate::handlers::setting::WebminCredentials {
                ...
                // ── Herramientas ──────────────────────────────────────────────
                egui::CollapsingHeader::new(egui::RichText::new(&tools_title).strong())
                    .default_open(true)
                    .show(ui, |ui| {
